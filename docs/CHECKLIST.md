...
## LLM evaluation
- [x] Build fixed structured-evidence evaluation fixtures
- [x] Add real Gemini tool-calling evaluation runner
- [x] Make final metric aggregation require manual review
